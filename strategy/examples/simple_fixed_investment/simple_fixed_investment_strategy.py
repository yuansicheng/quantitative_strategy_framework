...
class SimpleFixedInvestment(Strategy):
    def __init__(self, *args, strategy_args={}, **kwargs) -> None:
        ...
        self.last_sell_days = {asset: -1 for asset in self.asset_list}
    ...
    def backtestOneDay(self):
        ...
        # update sell dict
        for asset in self.last_sell_days:
            if self.last_sell_days[asset] != -1:
                self.last_sell_days[asset] += 1
